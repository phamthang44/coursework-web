...
?>
    <footer class="bg-gray-50 border-t border-gray-200 mt-8 dark:bg-darkmode dark:border-gray-700 transition-colors duration-300">
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><button class="about-quoraehub text-gray-600 dark:text-gray-300  hover:text-red-600 dark:hover:text-red-400 text-sm">About QuoraeHub</button></li>
        ...
        <script>
            const aboutKnowledgeHub = document.querySelector('.about-quoraehub');
