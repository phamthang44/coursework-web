...
<body class="bg-gray-100 dark:bg-darkmode2">
    ...
    if (!is_null($userObj)) {
        ...
        echo '<h1 class="text-2xl text-red-500 font-bold text-center mt-20 justify-center">❌ Email was sent unsuccessfully!</h1>';
        echo '<p class="text-gray-600 text-center mt-4 text-2xl dark:text-white">You will be redirected to the contact page in <span id="countdown" class="text-red-500 text-medium">5</span> seconds.</p>';
        echo '</div>';
